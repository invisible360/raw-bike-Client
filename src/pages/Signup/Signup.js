        ...
        <div className='flex justify-center items-center min-h-min my-10'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <button className="block w-full p-3 text-center rounded-sm text-gray-50 bg-cyan-600">Sign Up</button>
                </form>
                ...
                <p className="text-lg text-center sm:px-6 text-gray-600">New to this Website?
                    <Link rel="noopener noreferrer" to="/signup" className="underline text-gray-800">Create New Account</Link>
                </p>
            </div>

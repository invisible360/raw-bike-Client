        ...
        <div className="hero h-96 lg:h-[420px] relative" style={{ backgroundImage: `url(${banner})` }}>
            ...
            <div className="hero-content text-center">
                <div className="max-w-md text-white absolute top-28">
                    <h1 className="mb-5 text-4xl font-bold">Welcome to <br className='lg:hidden'></br> <span className='animate-pulse text-transparent bg-clip-text bg-gradient-to-r from-white text-4xl font-extrabold to-yellow-300'>Raw Bike</span></h1>
